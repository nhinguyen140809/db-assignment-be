...
BEGIN
    ...
    BEGIN TRY
        ...
        -- IF @Type NOT IN ( 'DELIVERY_FEE_DISCOUNT', 'PERCENTAGE_DISCOUNT', 'FIXED_AMOUNT_DISCOUNT' )
        -- BEGIN
        ...
        VALUES
        (@NewPromotionID, @OrderID, @Type, @MinOrderValue, @StartDate, @EndDate);

        IF @Type = 'DELIVERY_FEE_DISCOUNT'
        BEGIN
