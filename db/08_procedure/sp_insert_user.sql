...
BEGIN
    ...
    BEGIN TRY
        ...
        VALUES
        (@NewUserID, @Name, @Email, @PasswordHash, @Phone, 'CUSTOMER', @RegistrationDate);
...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            IF NOT EXISTS (SELECT 1 FROM [vehicle] WHERE vehicle_id = @VehicleID)
            BEGIN
        ...
        VALUES
        (@NewDriverID, @VehicleID, @DriverLicenseID, @Status);
