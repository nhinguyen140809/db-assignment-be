...
VALUES
    (
        'ORD0000000000007', 'RES0000000000004', 'FOO0000000000001', 4, 3.99, 'Extra salsa'
    ); -- 4 Beef Tacos
...
WHERE order_id IN ('ORD0000000000004', 'ORD0000000000001', 'ORD0000000000002', 'ORD0000000000005');
...
VALUES
    ...
    (
        'ORD0000000000004', 'USR0000000000009', 'USR0000000000004', 5, 'Excellent driver, very polite!', '2024-06-23 12:00:00'
    ), -- Review by Bob Brown for Frank Thomas
    (
...
VALUES
    ...
    (
        'ORD0000000000003', 'RES0000000000003', 'USR0000000000003', 5, 'Fresh sushi and excellent presentation!', '2024-06-22 14:00:00'
    ), -- Review by Alice Johnson for Sushi World
    (
        'ORD0000000000004', 'RES0000000000001', 'USR0000000000004', 4, 'Good food but a bit pricey.', '2024-06-23 12:10:00'
    ), -- Review by Bob Brown for Gourmet Bites
    (
